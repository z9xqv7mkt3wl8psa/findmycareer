...
const scholarships = [
  ...
  {
    name: "Rahmani30 Scholarship Entrance Examination 2025",
    provider: "Rahmani Mission",
    deadline: "25 January",
    amount: "Click on \"View Details\"",
    eligibility: "Class 7 to 9, Class 11",
    link: "https://gform"
  },
  {
    name: "FORTUNATE 40 Scholarship Test 2025",
    provider: "FIITJEE",
    deadline: "31 January",
    amount: "Click on \"View Details\"",
    eligibility: "Class 7 to 9, Class 11",
  ...
  {
    name: "Shahid Madho Singh Haath Kharcha Scholarship Scheme",
    provider: "ST & SC Development, Govt. Of Odisha",
  ...
  {
    name: "KK Vithani Foundation Scholarship 2024",
    provider: "K K Vithani Foundation",
  ...
  {
    name: "Aalo Scholarship 2024",
    provider: "Aalo Charity Organization",
    deadline: "31 August",
    amount: "Click on \"View Details\"",
    eligibility: "Class 11",
    link: "https://gform"
  ...
  {
    name: "SECMOLE Ladakh Scholarship 2024",
  ...
  {
    name: "Vidya Poshak Scholarship 2024",
    provider: "Vidya Poshak Trust",
    deadline: "31 July",
    amount: "Click on \"View Details\"",
    eligibility: "Class 11",
    link: "https://gform"
...
export default function Class11Scholarships() {
  ...
  const handleFilterChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (value === 'amount') {
      ...
      setFilteredScholarships([
        ...filteredScholarships.sort((a, b) => new Date(a.deadline).getTime() - new Date(b.deadline).getTime()),
      ]);
    } else {
